# Project Goal  
In this project, I would demonstrate <b>Random Forest</b> model to classify Cancer is Malignant(=1) or Benign (=0). After I build the preliminary random forest, I will tune my 
model and built the best random forest model. Last, I show the <b>variables important plot</b> to understand which variables are important.  
